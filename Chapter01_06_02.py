...
(2). 뮤택스(Mutex) : 공유된 자원의 데이터를 여러 스레드가 접근하는 것을 막는 것
    -> 경쟁 상태 예방
...
class FakeDataStore:
    ...
    def update(self, n):
        ...
        # self._lock.acquire()
        # logging.info('Thread %s has lcok', n)
        ...
        # logging.info('Thread %s about to release lcok', n)
